...
client.on('connect', function () {
	...
	console.log("Simple Subscriber for The Soil Sensor Application")
});
...
client.on('Soil_Humidity', function (msg) {
	...
	console.log("Recivied New Message from the fipy");
	console.log("Temperature is : " + decoded);
	console.log("Byte value: " + ascii_to_hex(decoded));
});
